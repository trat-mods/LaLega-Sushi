...
public abstract class LFeatures
{
    ...
    public static void initialize()
    {
        ...
        ConfiguredFeature configuredRiceFeature = configureFeature(RICE_FEATURE, new DefaultFeatureConfig(), Decorator.COUNT_CHANCE_HEIGHTMAP, new CountChanceDecoratorConfig(24, 0.5F));
